                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-10">
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Activate your Account</h3></div>
                                    <div class="card-body">
                                        <!-- Registration form-->
                                        <form onsubmit="event.preventDefault();">
                                            ...
                                            <div class="form-group mt-4 mb-0">
                                                <button class="btn btn-primary btn-block" id='btnRegister'>Activate Account</button>
                                            </div>
                                        </form>
                                    </div>
