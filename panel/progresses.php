...
<head>
    ...
    <title>CHS Strategy | Progresses</title>
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;2021-2025</a>
        <button class="btn btn-icon btn-transparent-dark " onclick="goBack()" id="sidebarToggle"><i class="fas fa-arrow-left"></i></button>
        <!-- Navbar Items-->
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title" style="font-size:1.5rem">
                                        <div class="page-header-icon"><i class="fas fa-signal"></i></div>
                                        Activity Progresses
                                    </h1>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="float-right form-row">
                                <button class="btn btn-primary ml-auto" id="addUserBtn" data-toggle="modal" data-target="#divProgressModal">
                                    <span class="icon text-white-70 mr-2">
                                        <i class="fas fa-user-plus"></i>
                                    </span>
                                    <span class="text"> Add Progress</span>
                                </button>
                        ...
                        <div class="card-body">
                            <div class="datatable">
                                <table class="table table-bordered table-hover" id="progressesDataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>Note</th>
                                            <th>Increment(%)</th>
                                            <th>Cumulative Progress value(%)</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
    ...
    <?php
        include_once("includes/dialogs/progress_dialog.php");
    ?>
